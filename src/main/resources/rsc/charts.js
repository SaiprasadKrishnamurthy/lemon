...
function switchttab(tab){
		...
		for(var i=0;i<allTabs.length;++i){
			if(allTabs[i].className.includes("customChartPopupTabActive"))
			{
      ...
      //Title Content
        ...
        var formDiv = document.createElement("div");
            ...
            var form = document.createElement("form");
                ...
                getAllSelectedInputsAndConvertChart(popupFormData,reportID,chartID,chartTitle);
            ...
            popupFormData.forEach(function(data,i){
              ...
              if(previousChoice != null)
              {
                ...
                textBox.setAttribute("placeholder", "Key Y-Axis name here...");
    ...
    function showPopover (d ) {
      ...
      div .html("<div class=\"title\">"+d.name+"</div><div class=\"content\">"+dataInput.xaxisLabel+": "+ d.label+"<br/>"+(d.y1 - d.y0) +"</div>")
          ...
          .style("top", (d3.event.pageY - 40) + "px");
            ...
            div .html("<div class=\"title\">"+d.name+"</div><div class=\"content\">"+dataInput.xaxisLabel+": "+ formatTime(d.label)+"<br/>"+dataInput.yaxisLabel+": "+(d.y1 - d.y0) +"</div>")
                      .style("left", (d3.event.pageX + 15) + "px")
                      .style("top", (d3.event.pageY - 40) + "px");
       }
    }
...
var dataCount = 0;
	...
	if(datas.length > 15)
	{
	    ...
	    var title = document.createElement("div");
	        title.setAttribute("noDataChartTitle");
	        title.innerHTML = data["title"];

	    var msg = document.createElement("div");
            msg.setAttribute("noDataChartMsg");
...
/*it will draw line */
function drawLine(id,dataInput,previousChoice,chartTitle)
{
setTimeout(function(){
   var color = d3.scale.ordinal()
               .range(["#95CEFF", "#90ed7d", "#f7a35c", "#8085e9", "#f15c80", "#808000", "#00FF00", "#FFD700", "#00FFFF",
	...
	var customChartImg = document.createElement("img");
        ...
        document.getElementById("lineChartContent_"+id).appendChild(customChartImg);
...
function drawTable(position,data)
{
	...
	{
		document.getElementById("tableContent_"+position).children[2].style="display:block";
		document.getElementById("tableContent_"+position).children[1].style="display:block";
